...
namespace Holoville.HOTween.Core
{
    ...
    {
        /// <summary>Ease function.</summary>
        public TweenDelegate.EaseFunc ease;

        /// <summary>Inverse ease function.</summary>
        ...
        /// <param name="p_ease">The ease function.</param>
        /// <param name="p_inverseEase">Inverse ease function.</param>
